...
3. **Cost-conscious model routing.**
   ...
   - The three parallel debate agents (Arthur/Clara/Leo — prose analysis, not strict JSON, and need to feel fast): Groq Llama-3.3-70b by default, Gemini 2.0 Flash as the documented alternate. Never route these through the expensive vision/synthesis model.
